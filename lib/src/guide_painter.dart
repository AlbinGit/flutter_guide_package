...
class MyCustomPainter extends CustomPainter {
  ...
  void paint(ui.Canvas canvas, ui.Size size) {
    ...
    if (tipsAlign == TipsAlign.topLeft) {
      ...
      centerPoint = TipsPoint(starPoint.x+pading+triangleLengh-tipsWidth/2.0, starPoint.y-triangleLengh-tipsHeight/2.0);
    }
    else if (tipsAlign == TipsAlign.topCenter) {
      starPoint = TipsPoint(a.x+pointWidth/2.0, a.y-gap);
      centerPoint = TipsPoint(starPoint.x, starPoint.y-triangleLengh-tipsHeight/2.0);
    }
      ...
      centerPoint = TipsPoint(starPoint.x-triangleLengh-tipsWidth/2.0, starPoint.y-triangleLengh-pading+tipsHeight/2.0);
    }
